        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        "pretrained": "/data4/userFolder/davidqu/study/hover_net-master/pretrained/ImageNet-ResNet50-Preact_pytorch.tar",
                        # 'pretrained': None,
                    },
                },
            ...
            },
            {
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},   #<------------从run_train.py跳转过来
